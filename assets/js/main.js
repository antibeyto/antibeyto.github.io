    ...
    $(window).scroll(function () {
        ...
        if (!navbar.hasClass('relative')) {
            ...
            // Up
                ...
                if (position >= window.innerHeight && window.innerWidth >= 250) {
                    toTop.fadeIn('fast');
...
jQuery(function($) {
    ...
    function particles(type, ID) {
        ...
        if(type === 'default') {
            particlesJS(ID,{particles:{number:{value:80,density:{enable:!0,value_area:800}},color:{value:"#ffffff"},shape:{type:"circle",stroke:{width:0,color:"#000000"},polygon:{nb_sides:5},image:{src:"",width:100,height:100}},opacity:{value:.25,random:!1,anim:{enable:!1,speed:1,opacity_min:.1,sync:!1}},size:{value:5,random:!0,anim:{enable:!1,speed:40,size_min:.1,sync:!1}},line_linked:{enable:!0,distance:150,color:"#ffffff",opacity:.25,width:1},move:{enable:!0,speed:6,direction:"none",random:!1,straight:!1,out_mode:"out",attract:{enable:!1,rotateX:600,rotateY:1200}}},interactivity:{detect_on:"canvas",events:{onhover:{enable:0,mode:"repulse"},onclick:{enable:!0,mode:"push"},resize:!0},modes:{grab:{distance:400,line_linked:{opacity:1}},bubble:{distance:400,size:40,duration:2,opacity:8,speed:3},repulse:{distance:200},push:{particles_nb:4},remove:{particles_nb:2}}},retina_detect:!0,config_demo:{hide_card:!1,background_color:"black",background_image:"",background_position:"50% 50%",background_repeat:"no-repeat",background_size:"cover"}});
        }

        if(type === 'bubble') {
            particlesJS(ID,{particles:{number:{value:6,density:{enable:!0,value_area:800}},color:{value:"#182c50"},shape:{type:"polygon",stroke:{width:0,color:"#000"},polygon:{nb_sides:6},image:{src:"",width:100,height:100}},opacity:{value:.3,random:!0,anim:{enable:!1,speed:1,opacity_min:.1,sync:!1}},size:{value:160,random:!1,anim:{enable:!0,speed:10,size_min:40,sync:!1}},line_linked:{enable:!1,distance:200,color:"#ffffff",opacity:1,width:2},move:{enable:!0,speed:8,direction:"none",random:!1,straight:!1,out_mode:"out",bounce:!1,attract:{enable:!1,rotateX:600,rotateY:1200}}},interactivity:{detect_on:"canvas",events:{onhover:{enable:!1,mode:"grab"},onclick:{enable:!1,mode:"push"},resize:!0},modes:{grab:{distance:400,line_linked:{opacity:1}},bubble:{distance:400,size:40,duration:2,opacity:8,speed:3},repulse:{distance:200,duration:.4},push:{particles_nb:4},remove:{particles_nb:2}}},retina_detect:!0});
        }
        ...
        $(document).one('inview', item, function(event, inview) {
            ...
            if (inview) {            
                ...
                $(item).each(function() {
                    ...
                    var pcolor  = getComputedStyle(document.documentElement).getPropertyValue('--aarda-color');
                    var scolor  = getComputedStyle(document.documentElement).getPropertyValue('--aarda-color');
...
jQuery(function ($) {
    ...
    $(document).on('keyup', '#leverage-form .field-email', function() {
        ...
        let data    = { 
            'email':email, 
            'step':'check_email', 
            'action':'https://formspree.io/f/xbjbqvba', 
            'section':'aarda', 
        ...
        timer = setTimeout(function() {
            ...
            $.post(url, data, function(response) {
                try {
                    ...
                    alert('Şimdilik siktir git. Sunucularım bozuldu.');
                }
            })
        }, 1000)
    })
...
jQuery(function ($) {
    ...
    if(cookieNotice) {
        ...
        gdprCookieNoticeLocales.en = {
            description: 'Hey! Çerezler, deneyiminizi geliştirir.',
            settings: 'Ayarlar',
            accept: 'Kabul et',
            statement: 'Geliştirici',
            save: 'Kaydet',
            always_on: 'Gerekli',
            cookie_essential_title: 'Sistem*',
            cookie_essential_desc: 'Bişeyler depolamak zorundayım...',
            cookie_performance_title: 'Performans',
            cookie_performance_desc: 'İzin verirseniz performans arttırmak için kullanılır!',
            cookie_analytics_title: 'Analiz',
            cookie_analytics_desc: 'İzin verseniz dahi kullanılmaz!',
            cookie_marketing_title: 'Reklam',
            cookie_marketing_desc: 'İzin verseniz dahi kullanılmaz!'
        }
